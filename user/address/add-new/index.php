...
<body>
    ...
    <div class="addAddressContainer">
        ...
        <input type="email" id="AddAddressEmail" value="<?= isset($_SESSION['CFuserData']['EmailID']) ? $_SESSION['CFuserData']['EmailID'] : ""  ?>" class="addAddressInput" placeholder="Enter your email" required>
        ...
        <input type="text" id="AddAddressFullName" value="<?= isset($_SESSION['CFuserData']['FName']) ? $_SESSION['CFuserData']['FName'] : ""; ?> <?= isset($_SESSION['CFuserData']['LName']) ? $_SESSION['CFuserData']['LName'] : ""  ?>" class="addAddressInput" placeholder="Enter your full name" required>

        <label class="addAddressLabel">Mobile No<span class="addAddressRequiredStar">*</span></label>
        <input type="text" id="AddAddressMobileNo" value="<?= isset($_SESSION['CFuserData']['MobileNo']) ? $_SESSION['CFuserData']['MobileNo'] : ""  ?>" class="addAddressInput" placeholder="Enter your mobile number" required>
        ...
        <button class="addAddressButton" id="AddAddressSubmit" onclick="submitForm()">Add Address</button>
